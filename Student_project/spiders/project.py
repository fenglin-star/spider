# # -*- coding: utf-8 -*-
# import scrapy
# from Student_project.items import StudentProjectItem
# from urllib.parse import urlencode
#
# class ProjectSpider(scrapy.Spider):
#     name = 'project'
#     allowed_domains = ['cy.ncss.org.cn']
#     start_urls = ['http://cy.ncss.org.cn/search/projectlist?name=&industryCode=&typeCode=&wasBindUniTechnology=-9&investStageCode=&provinceCode=43&pageIndex=0&pageSize=15']
#
#     def parse_page(self, response):
#         datas = response.css('.search-list-item')
#         for data in datas:
#             item = StudentProjectItem()
